...
static VkDescriptorUpdateTemplate createUpdateTemplate(VkDevice device, VkPipelineBindPoint bindPoint, VkPipelineLayout layout, VkDescriptorSetLayout setLayout, Shaders shaders, bool pushDescriptorSupported)
{
    ...
    uint32_t resourceMask = gatherResources(shaders, resourceType);
    ...
    VkPipelineLayout layout, Constants constants)
{
    ...
    VkPipelineRasterizationStateCreateInfo rasterisationState = { VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO };
    rasterisationState.lineWidth = 1.f;
    rasterisationState.frontFace = VK_FRONT_FACE_CLOCKWISE;
    rasterisationState.cullMode = VK_CULL_MODE_BACK_BIT;
    ...
    VkPipelineColorBlendStateCreateInfo colourBlendState = { VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO };
